...
export default function LoginPage() {
  return (
    <div className="font-[sans-serif] bg-white md:max-h-full">
      <div className="grid md:grid-cols-2 items-center gap-8 min-h-screen">
        <div className="max-md:order-1 w-full h-full bg-gray-50 md:rounded-tr-xl md:rounded-br-xl lg:p-12 p-8">
          <img
